...
#PART 5: Stop the checker early if the chosen item is not in stock
...
markup = int(input("Enter a markup amount to add to the price of each item: "))

#PART 7: Apply markup to every price using map()
marked_up_prices = list(map(lambda p: p + markup, prices))
print("Marked Up Prices:", marked_up_prices)

#PART 8: Find the marked up price of the chosen items
